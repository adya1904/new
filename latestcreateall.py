...
def create_file_new(typescript='testscript',baseurl="", projectid= "1111",userstoryid="2222",method=None,endpoint=None,parameter=None,contenttype=None, auth_type=None, parameter_values=None,featurename=None,scenarioname=None,pointingattribute=None,headers=None,auth=None,featuresdir='features/'):
