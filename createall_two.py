...
def create_test_script(headers,auth,base_file_name,method, endpoint, parameter=None,baseurl = 'https://petstore3.swagger.io/api/v3'):     
...
def create_cucumber_script(baseurl,base_file_name,endpoints,methods,parameter_values,parameters,headers,auth):
    try:                                   #exception handeling
        file = createfile(typefile = 'py',base_file_name=base_file_name)
        txt = testcucumber.format(baseurl=baseurl,method=methods,endpoint = endpoints, parameter_value= parameter_values, parameter = parameters,headers=headers,auth=auth)  
        #print (testcucumber)  
        with open(file.name, 'w') as f:    #open(file.name, w) is for writing things into the file
            f.write (txt) 
...
def add_cucumber_script(baseurl,base_file_name,endpoints,methods,parameter_values,parameters,headers,auth):
    try:                                   #exception handeling
        ...
        txt = addtestcucumber.format(baseurl=baseurl,method=methods,endpoint = endpoints, parameter_value= parameter_values, parameter = parameters,headers=headers,auth=auth)  
...
def create_file(featuresdir='features/',baseurl=None,typescript=None,projectid= None,userstoryid=None,method=None,endpoint=None,parameter=None,parameter_values=None,featurename=None,scenarioname=None,pointingattribute=None,headers=None,auth=None):
    if typescript == 'testscript':           
        ...
        create_test_script(headers=headers,auth=auth,baseurl=baseurl,base_file_name=base_file_name,method=method, endpoint= endpoint, parameter=parameter)
    if typescript == 'stepsscript':
        base_file_name =featuresdir+"steps/"+"testcucumber"+projectid+userstoryid
        create_cucumber_script(baseurl=baseurl,base_file_name= base_file_name,endpoints=endpoint,methods=method,parameter_values=parameter_values,parameters=parameter,headers=headers,auth=auth)
    ...
    if typescript=='addtostepsscript':
        ...
        add_cucumber_script(baseurl=baseurl,base_file_name= base_file_name,endpoints=endpoint,methods=method,parameter_values=parameter_values,parameters=parameter,headers=headers,auth=auth)
       

def create_file_new(featuresdir='features/',baseurl=None,typescript=None,projectid= None,userstoryid=None,method=None,endpoint=None,parameter=None,parameter_values=None,featurename=None,scenarioname=None,pointingattribute=None,headers=None,auth=None,auth_type=None):
    ...
    create_file(featuresdir=featuresdir,baseurl=baseurl,typescript=typescript,projectid= projectid,userstoryid=userstoryid,method=method,endpoint=endpoint,parameter=parameter,parameter_values=parameter_values,featurename=featurename,scenarioname=scenarioname,pointingattribute=pointingattribute,headers=headers,auth=auth)    
...
githubheader={'Authorization': 'token ' + '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' }   #authentication usinf header
...
create_file_new(baseurl=baseurl2,typescript='createfeature',projectid='peet',userstoryid='storee',featurename = 'testing httpbin API authentication', scenarioname ='API authentication for httpbin' ,endpoint =endpoint2 , pointingattribute = 'userid', method='GET',parameter=None,parameter_values='userid',auth="('user', 'pass')",auth_type='HTTPDigestAuth')
create_file_new(baseurl=baseurl3,typescript='addtofeature',projectid='peet',userstoryid='storee',featurename = 'testing github API authentication', scenarioname ='API authentication for github' ,endpoint =endpoint3 , pointingattribute = 'githubuserid2', method='GET',parameter={'type':'all'},parameter_values='githubuserid2', auth=githubheader,auth_type='headers')
...
#create_file(baseurl=baseurl3,typescript='addtostepsscript',projectid='peet',userstoryid='storee',featurename = 'testing github API authentication', scenarioname ='API authentication for github' ,endpoint =endpoint3 , pointingattribute = 'githubuserid2', method='GET',parameter={'type':'all'},parameter_values='githubuserid2', headers=githubheader)
create_file_new(baseurl=baseurl2,typescript='stepsscript',projectid='peet',userstoryid='storee',featurename = 'testing httpbin API authentication', scenarioname ='API authentication for httpbin' ,endpoint =endpoint2 , pointingattribute = 'userid', method='GET',parameter=None,parameter_values='userid',auth="('user', 'pass')",auth_type='HTTPDigestAuth')
create_file_new(baseurl=baseurl3,typescript='addtostepsscript',projectid='peet',userstoryid='storee',featurename = 'testing github API authentication', scenarioname ='API authentication for github' ,endpoint =endpoint3 , pointingattribute = 'githubuserid2', method='GET',parameter={'type':'all'},parameter_values='githubuserid2', auth=githubheader,auth_type='headers')
